...
sensor_name = "dsdma Temperature Sensor"
values_x = times
values_y = values
# print(values_y)
# values_x_p = times_p
...
plt.plot(values_x, values_y, '.r', color='royalblue', label='Corrected Values', linewidth=0.1)
# plt.plot(values_x_p, values_y_p, '.r', color='red', label='Predictions', linewidth=1.1)
...
# f.savefig("dsdma_missing.pdf", bbox_inches='tight')
plt.show()
